...
const router = express.Router() //aqui estou configurando a primeira parte da router
...
conectaBancoDeDados() //estou chamando a função que conecta ao bancoDeDados
...
async function corrigeMulher(request, response) {
   try{
    ...
    if (request.body.imagem){
        mulherEncontrada.imagem = request.body.minibio
    }
